...
(declare-datatype
  Uint
  ((Nil) (D0 (proj1-D0 Uint)) (D1 (proj1-D1 Uint))
   (D2 (proj1-D2 Uint)) (D3 (proj1-D3 Uint)) (D4 (proj1-D4 Uint))
   (D5 (proj1-D5 Uint)) (D6 (proj1-D6 Uint)) (D7 (proj1-D7 Uint))
   (D8 (proj1-D8 Uint)) (D9 (proj1-D9 Uint))))
(declare-datatype
  Positive ((XI (proj1-XI Positive)) (XO (proj1-XO Positive)) (XH)))
(declare-datatype
  Z ((Z0) (Zpos (proj1-Zpos Positive)) (Zneg (proj1-Zneg Positive))))
(declare-datatype Nat ((O) (S (proj1-S Nat))))
(declare-datatype N ((N0) (Npos (proj1-Npos Positive))))
(declare-datatype
  Mask ((IsNul) (IsPos (proj1-IsPos Positive)) (IsNeg)))
(declare-datatype
  Int2 ((Pos (proj1-Pos Uint)) (Neg (proj1-Neg Uint))))
(declare-datatype Comparison ((Eq) (Lt) (Gt)))
(define-fun
  zero
  () Z Z0)
(define-fun
...
(prove (= (zzdouble Z0) Z0))
(prove (= (zzopp Z0) Z0))
(prove (= (zzpred Z0) (Zneg XH)))
(prove (= (zzsucc Z0) (Zpos XH)))
(prove (forall ((x Z) (y Z)) (= (zzadd y x) (zzadd x y))))
(prove (forall ((x Z)) (= (zzdouble x) (zzadd x x))))
(prove (forall ((x Z)) (= (zzcompare x x) Eq)))
(prove (forall ((x Z)) (zzleb x x)))
(prove (forall ((x Z) (y Z)) (= (zzmul y x) (zzmul x y))))
(prove (forall ((x Z)) (= (zzsub x x) Z0)))
(prove (forall ((x Z)) (= (zzadd x Z0) x)))
(prove
  (forall ((x Positive)) (= (zzdouble (Zneg x)) (Zneg (XO x)))))
(prove
  (forall ((x Positive)) (= (zzdouble (Zpos x)) (Zpos (XO x)))))
(prove (forall ((x Z)) (= (zzmul x Z0) Z0)))
(prove (forall ((x Positive)) (= (zzopp (Zneg x)) (Zpos x))))
(prove (forall ((x Positive)) (= (zzopp (Zpos x)) (Zneg x))))
(prove
  (forall ((x Z)) (= (zzopp (zzdouble x)) (zzdouble (zzopp x)))))
(prove (forall ((x Z)) (= (zzopp (zzopp x)) x)))
(prove (forall ((x Z)) (= (zzpred (zzopp x)) (zzopp (zzsucc x)))))
(prove (forall ((x Z)) (= (zzpred (zzsucc x)) x)))
(prove (forall ((x Z)) (= (zzsub x Z0) x)))
(prove (forall ((x Z)) (= (zzopp x) (zzsub Z0 x))))
(prove (= (zzpred (Zneg XH)) (Zneg (XO XH))))
(prove (forall ((x Z) (y Z)) (= (zzsub x y) (zzadd x (zzopp y)))))
(prove
  (forall ((x Z) (y Z))
    (= (zzadd y (zzpred x)) (zzadd x (zzpred y)))))
(prove
  (forall ((x Z)) (= (zzadd x (zzpred x)) (zzpred (zzdouble x)))))
(prove
  (forall ((x Z) (y Z))
    (= (zzadd y (zzsucc x)) (zzadd x (zzsucc y)))))
(prove
  (forall ((x Z)) (= (zzadd x (zzsucc x)) (zzsucc (zzdouble x)))))
(prove
  (forall ((x Z)) (= (zzcompare x (zzdouble x)) (zzcompare Z0 x))))
(prove
  (forall ((x Z) (y Z))
    (= (zzcompare y (zzopp x)) (zzcompare x (zzopp y)))))
(prove
  (forall ((x Z)) (= (zzcompare x (zzopp x)) (zzcompare x Z0))))
(prove (forall ((x Z)) (= (zzcompare x (zzpred x)) Gt)))
(prove (forall ((x Z)) (= (zzcompare x (zzsucc x)) Lt)))
(prove
  (forall ((x Z)) (= (zzcompare (zzdouble x) x) (zzcompare x Z0))))
(prove
  (forall ((x Z) (y Z))
...
(prove (forall ((x Z)) (= (zzleb x (zzdouble x)) (zzleb Z0 x))))
(prove
  (forall ((x Z) (y Z)) (= (zzleb y (zzopp x)) (zzleb x (zzopp y)))))
(prove (forall ((x Z)) (= (zzleb x (zzopp x)) (zzleb x Z0))))
(prove (forall ((x Z)) (not (zzleb x (zzpred x)))))
(prove (forall ((x Z)) (zzleb x (zzsucc x))))
(prove (forall ((x Z)) (= (zzleb (zzdouble x) x) (zzleb x Z0))))
(prove
  (forall ((x Z) (y Z)) (= (zzleb (zzopp y) x) (zzleb (zzopp x) y))))
(prove
  (forall ((x Z) (y Z))
...
(prove
  (forall ((x Z) (y Z)) (= (zzmul y (zzopp x)) (zzmul x (zzopp y)))))
(prove
  (forall ((x Z) (y Z)) (= (zzopp (zzmul x y)) (zzmul x (zzopp y)))))
(prove (forall ((x Z) (y Z)) (= (zzopp (zzsub y x)) (zzsub x y))))
(prove
  (forall ((x Z) (y Z))
    (= (zzpred (zzadd x y)) (zzadd x (zzpred y)))))
(prove (forall ((x Z)) (= (zzopp x) (zzsub x (zzdouble x)))))
(prove (forall ((x Z)) (= (zzsub x (zzpred x)) (Zpos XH))))
(prove
  (forall ((x Z) (y Z))
    (= (zzsucc (zzadd x y)) (zzadd x (zzsucc y)))))
(prove (forall ((x Positive)) (= (zzcompare Z0 (Zneg x)) Gt)))
(prove (forall ((x Positive)) (= (zzcompare Z0 (Zpos x)) Lt)))
(prove
  (forall ((x Z)) (= (zzcompare Z0 (zzdouble x)) (zzcompare Z0 x))))
(prove
  (forall ((x Z)) (= (zzcompare (zzdouble x) Z0) (zzcompare x Z0))))
(prove (forall ((x Positive)) (not (zzleb Z0 (Zneg x)))))
(prove (forall ((x Positive)) (zzleb Z0 (Zpos x))))
(prove (forall ((x Z)) (= (zzleb Z0 (zzdouble x)) (zzleb Z0 x))))
(prove (forall ((x Z)) (= (zzleb (zzdouble x) Z0) (zzleb x Z0))))
(prove (forall ((x Z)) (= (zzopp x) (zzmul x (Zneg XH)))))
(prove
  (forall ((x Positive))
