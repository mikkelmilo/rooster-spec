...
(prove
  :lemma
  (forall ((x Z) (y Z)) (= (zzadd y x) (zzadd x y))))
(prove
  :lemma
  (forall ((x Z)) (= (zzdouble x) (zzadd x x))))
(prove
  :lemma
  (forall ((x Z)) (= (zzcompare x x) Eq)))
(prove
  :lemma
  (forall ((x Z)) (zzleb x x)))
(prove
  :lemma
  (forall ((x Z) (y Z)) (= (zzmul y x) (zzmul x y))))
(prove
  :lemma
  (forall ((x Z)) (= (zzsub x x) Z0)))
(prove
  :lemma
  (forall ((x Z)) (= (zzadd x Z0) x)))
(prove
  :lemma
...
(prove
  :lemma
  (forall ((x Z)) (= (zzmul x Z0) Z0)))
(prove
  :lemma
  (forall ((x Positive)) (= (zzopp (Zneg x)) (Zpos x))))
(prove
  :lemma
  (forall ((x Positive)) (= (zzopp (Zpos x)) (Zneg x))))
(prove
  :lemma
  (forall ((x Z)) (= (zzopp (zzdouble x)) (zzdouble (zzopp x)))))
(prove
  :lemma
  (forall ((x Z)) (= (zzopp (zzopp x)) x)))
(prove
  :lemma
  (forall ((x Z)) (= (zzpred (zzopp x)) (zzopp (zzsucc x)))))
(prove
  :lemma
  (forall ((x Z)) (= (zzpred (zzsucc x)) x)))
(prove
  :lemma
  (forall ((x Z)) (= (zzsub x Z0) x)))
(prove
  :lemma
  (forall ((x Z)) (= (zzopp x) (zzsub Z0 x))))
(prove
  :lemma
  (= (zzpred (Zneg XH)) (Zneg (XO XH))))
(prove
  :lemma
  (forall ((x Z) (y Z)) (= (zzsub x y) (zzadd x (zzopp y)))))
(prove
  :lemma
  (forall ((x Z) (y Z))
...
(prove
  :lemma
  (forall ((x Z)) (= (zzcompare x (zzpred x)) Gt)))
(prove
  :lemma
  (forall ((x Z)) (= (zzcompare x (zzsucc x)) Lt)))
(prove
  :lemma
...
(prove
  :lemma
  (forall ((x Z)) (= (zzleb x (zzdouble x)) (zzleb Z0 x))))
(prove
  :lemma
  (forall ((x Z) (y Z)) (= (zzleb y (zzopp x)) (zzleb x (zzopp y)))))
(prove
  :lemma
  (forall ((x Z)) (= (zzleb x (zzopp x)) (zzleb x Z0))))
(prove
  :lemma
  (forall ((x Z)) (not (zzleb x (zzpred x)))))
(prove
  :lemma
  (forall ((x Z)) (zzleb x (zzsucc x))))
(prove
  :lemma
  (forall ((x Z)) (= (zzleb (zzdouble x) x) (zzleb x Z0))))
(prove
  :lemma
...
(prove
  :lemma
  (forall ((x Z) (y Z)) (= (zzopp (zzsub y x)) (zzsub x y))))
(prove
  :lemma
  (forall ((x Z) (y Z))
...
(prove
  :lemma
  (forall ((x Z)) (= (zzopp x) (zzsub x (zzdouble x)))))
(prove
  :lemma
  (forall ((x Z)) (= (zzsub x (zzpred x)) (Zpos XH))))
(prove
  :lemma
  (forall ((x Z) (y Z))
...
(prove
  :lemma
  (forall ((x Positive)) (= (zzcompare Z0 (Zneg x)) Gt)))
(prove
  :lemma
  (forall ((x Positive)) (= (zzcompare Z0 (Zpos x)) Lt)))
(prove
  :lemma
...
(prove
  :lemma
  (forall ((x Positive)) (not (zzleb Z0 (Zneg x)))))
(prove
  :lemma
  (forall ((x Positive)) (zzleb Z0 (Zpos x))))
(prove
  :lemma
  (forall ((x Z)) (= (zzleb Z0 (zzdouble x)) (zzleb Z0 x))))
(prove
  :lemma
  (forall ((x Z)) (= (zzleb (zzdouble x) Z0) (zzleb x Z0))))
(prove
  :lemma
  (forall ((x Z)) (= (zzopp x) (zzmul x (Zneg XH)))))
(prove
  :lemma
  (forall ((x Positive))
