...
(declare-datatype
  Bool2 :source |Bool| ((True :source True) (False :source False)))
(define-fun
  two :keep :source two
  () Z (Zpos (XO XH)))
(define-fun
     ...
     ((Zpos p)
      (match x
        ((Z0 False)
         ...
         ((Zneg a02)
          (match (testbit0 (pred_N a02) (Npos p))
            ((True False)
             (False True)))))))
     ((Zneg z) False))))
(define-fun
      ...
      (match (pos_div_eucl |a'| y)
        (((pair2 q r)
          (let ((|r'| (succ_double0 r)))
            (match (leb0 y |r'|)
              ((True (pair2 (succ_double0 q) (sub0 |r'| y)))
               (False (pair2 (double0 q) |r'|)))))))))
     ((XO |a'2|)
      (match (pos_div_eucl |a'2| y)
        (((pair2 p r2)
          (let ((|r'2| (double0 r2)))
            (match (leb0 y |r'2|)
              ((True (pair2 (succ_double0 p) (sub0 |r'2| y)))
               (False (pair2 (double0 p) |r'2|)))))))))
     (XH
      (match y
        ((N0 (pair2 N0 (Npos XH)))
         ((Npos p2)
         ...
         ((IsPos r)
          (let
            ((|s'| (XI (XO s)))
             (|r'| (@ y (@ x r))))
            (match (leb |s'| |r'|)
              ((True (pair2 (XI s) (sub_mask |r'| |s'|)))
               (False (pair2 (XO s) (IsPos |r'|)))))))))))))
(define-fun-rec
            ...
            (match (ltb |r'| y)
              ((True
                (let ((|x'2| (XO XH)))
                  (match q
                    ((Z0 (pair2 Z0 |r'|))
                     ((Zpos |y'3|) (pair2 (Zpos (mul |x'2| |y'3|)) |r'|))
                     ((Zneg |y'22|) (pair2 (Zneg (mul |x'2| |y'22|)) |r'|))))))
               (False
                (let ((|x'3| (XO XH)))
                  (match q
                    ((Z0 (pair2 (add1 Z0 (Zpos XH)) (sub1 |r'| y)))
                     ((Zpos |y'4|)
                      (pair2 (add1 (Zpos (mul |x'3| |y'4|)) (Zpos XH)) (sub1 |r'| y)))
                     ((Zneg |y'23|)
                      (pair2 (add1 (Zneg (mul |x'3| |y'23|)) (Zpos XH))
                        (sub1 |r'| y))))))))))))))
     ((XO |a'2|)
            ...
            (match (ltb |r'2| y)
              ((True
                (let ((|x'5| (XO XH)))
                  (match p
                    ((Z0 (pair2 Z0 |r'2|))
                     ((Zpos |y'6|) (pair2 (Zpos (mul |x'5| |y'6|)) |r'2|))
                     ((Zneg |y'25|) (pair2 (Zneg (mul |x'5| |y'25|)) |r'2|))))))
               (False
                (let ((|x'6| (XO XH)))
                  (match p
                    ((Z0 (pair2 (add1 Z0 (Zpos XH)) (sub1 |r'2| y)))
                     ((Zpos |y'7|)
                      (pair2 (add1 (Zpos (mul |x'6| |y'7|)) (Zpos XH)) (sub1 |r'2| y)))
                     ((Zneg |y'26|)
                      (pair2 (add1 (Zneg (mul |x'6| |y'26|)) (Zpos XH))
                        (sub1 |r'2| y))))))))))))))
     (XH
      (match y
        ((_ (pair2 (Zpos XH) Z0))
